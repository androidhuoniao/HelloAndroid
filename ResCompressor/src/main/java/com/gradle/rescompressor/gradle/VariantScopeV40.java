...
import static com.gradle.rescompressor.gradle.ArtifactTypesV40Kt.ARTIFACT_TYPES;


class VariantScopeV40 {
    ...
    @NotNull
    static Collection<File> getFinalArtifactFiles(@NotNull final VariantScope scope, @NotNull final SingleArtifactType<? extends FileSystemLocation> type) {
