...
val SCOPE_FULL_WITH_FEATURES: MutableSet<in QualifiedContent.Scope> =  TransformManager.SCOPE_FULL_PROJECT

val SCOPE_FULL_LIBRARY_WITH_FEATURES: MutableSet<in QualifiedContent.Scope> = TransformManager.PROJECT_ONLY
